       ...
       <div className="bg-gray-100 mt-24 min-h-screen">
            ...
            <nav className="bg-blue-600 text-white py-4 px-6 shadow-md">
                <div className="container mx-auto flex justify-between items-center">
                    <h1 className="text-xl font-bold">E_Training Dogs</h1>
            ...
            <header className="bg-blue-500 text-white py-16">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-lg">Teach your Dog or puppies basic skill and teach them corect way.</p>
                </div>
            </header>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <iframe
                                width="100%"
                                height="200"
                                src="https://www.youtube-nocookie.com/embed/jFMA5ggFsXU?si=0G-mTrI9TU3D8ui6" // Replace with your YouTube video URL
                            ...
                            ></iframe>
                            <div className="p-4">
                                <h4 className="font-bold text-gray-800">Train Any Dog</h4>
                                <p className="text-gray-600">Basic to teach all Dogs.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <iframe
                                width="100%"
                                height="200"
                                src="https://www.youtube.com/embed/Y0pamvXAXpA?si=yPzBauBH0kHCTBuH&amp" // Replace with your YouTube video URL
                            ...
                            ></iframe>
                            <div className="p-4">
                                <h4 className="font-bold text-gray-800">BAsic Sign Language for Dogs</h4>
                        ...
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <iframe
                                width="100%"
                                height="200"
                                src="https://www.youtube.com/embed/HTXajoc4a3k?si=EmvbbnLpofUC3ghm&amp;controls=0&amp" // Replace with your YouTube video URL
                            ...
                            ></iframe>
                            <div className="p-4">
                                <h4 className="font-bold text-gray-800">For Puppiest</h4>
