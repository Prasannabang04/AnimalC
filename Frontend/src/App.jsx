  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/rescue" element={<Rescues />} />
        <Route path="/etrain" element={<E_train />} />
        <Route path="/blogs" element={<Bloges />} />
        <Route path="/sb1" element={<Snake1 />} />
        <Route path="/sb2" element={<Snake2 />} />
        <Route path="/etd" element={<Etraind />} />
        <Route path="/etc" element={<Etrainc />} />
        <Route path="/lost-pets" element={<LostPets />} />
        <Route path="/found-pets" element={<FoundPets />} />
        <Route path="/display-pets" element={<DisplayPets />} />
        <Route path="/pets/:centerId" element={<PetsPage />} />
        <Route path="/forms" element={<PetAdoptionForm />} />
        <Route path="/appointment" element={<AppointmentForm />} />
        <Route path="/match" element={<MatchPet />} />
